...
export default function Home() {
  ...
  return (
    <View className="flex-1 bg-transparent">
      <View className=" bg-blue-200 rounded-bl-3xl rounded-br-3xl flex justify-center gap-y-8 " style={{ paddingVertical: hp(8), height: hp(35), paddingHorizontal: hp(4) }}>
      ...
      {vuelos &&
        <ScrollView className="flex" style={{ maxHeight: hp(45), paddingHorizontal: hp(2) }}>
          <Card
            origen="BCN"
            destino="MAD"
            fechas="01/01/2024 - 07/01/2024"
            precio={300}
          />
          <Card
            origen="BCN"
